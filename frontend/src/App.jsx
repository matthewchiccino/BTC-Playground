    ...
    <div className="app">
      <div className="topbar">
        <h1 className="app-title-link" onClick={goHome}>
          <img src="/Bitcoin.svg.webp" alt="" className="app-logo" />
          BTC Playground
        </h1>
        ...
        <NodeStatus />
        <a
          href="https://github.com/matthewchiccino/BTC-Playground/"
          target="_blank"
          rel="noreferrer"
              ...
              <div className="panes">
                ...
                <div className="pane">
                  <div className="pane-header">
                    ...
                    {stage === "selected" && (
                      <button className="action-btn action-btn-primary" onClick={() => doBuild()}>
                        Build Payload
                      </button>
                    )}
                    {buildData && (
